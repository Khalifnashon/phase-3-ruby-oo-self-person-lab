# your code goes here
class Person
    # New person cannot overwrite the name they were instantiated with using attr_reader
    attr_reader :name
    ...
    def initialize(name,bank_account = 25, happiness = 8, hygiene = 8)
        @name = name
        # a new person is instantiated with bank_account 25
    ...
    # Does not allow a person to change the happiness above 10
    # Does not allow a person to change the happiness below 0
    def happiness= (value)
        if(value < 0)
            @happiness = 0
        elsif(value>10)
    ...
    # Hygiene setter method happiness= : sets 0>=happiness<=10
    def hygiene= (value)
        if(value < 0)
            @hygiene = 0
        elsif(value>10)
    ...
    # using self to work on the person objects 
    ...
    # call_friend method: accepts another instance of Person as "friend" +
    # increments the person's and the friend's happiness by 3 points + 
    # return a string "Hi #{friend.name}! It's #{self.name}. How are you?"
